...
(async () => {
  ...
  const eyes = new Eyes(new VisualGridRunner()); // Use VisualGridRunner if you want to use VisualGrid, or ClassicRunner otherwise
  ...
  config.setAppName('Demo app - Storybook App');
  config.setTestName('Storybook Async');
